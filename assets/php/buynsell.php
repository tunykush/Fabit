...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../css/buynsell.css" />
    ...
    <header class="header" data-header>
      ...
      <div class="container">
        ...
        <nav class="navbar" data-navbar>
          <ul class="navbar-list">
            <li class="navbar-item">
              <a href="../../landingpage.html" class="navbar-link active" data-nav-link>Homepage</a>
            </li>
        ...
        <div class="btn-containerr">
          <a href="../html/logsign.html" class="btn-stroke">Login</a>
          <a href="../html/logsign.html" class="btn-stroke">Sign Up</a>
